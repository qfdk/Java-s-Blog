...
<div class="content">	
    ...
    <ul class="pager">
        <li><a href="UserServlet?action=listerNews&NumPage=<%=nbpageInteger - 1%>">Previous</a></li>
            <%
                if (nbpageInteger >= maxI) {
            %>
        <li><a href="UserServlet?action=listerNews&NumPage=<%=maxI%>">Next</a></li>
            <%
          } else {%>
        <li><a href="UserServlet?action=listerNews&NumPage=<%=nbpageInteger + 1%>">Next</a></li>
            <%
                }
